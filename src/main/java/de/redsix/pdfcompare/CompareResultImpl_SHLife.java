 ...
 */
public class CompareResultImpl_SHLife extends CompareResultImpl {

    private static final Logger LOG = LoggerFactory.getLogger(CompareResultImpl_SHLife.class);
    ...
    public boolean writeTo(String filename) {
        return writeTo(doc -> doc.save(filename));
    }
